...
<section class="profil">
    <div class="container">
        <h1 style="color: #FE3F00; text-align: center; margin-bottom:3%;">PROFIL</h1>
        <div class="row justify-content-center">
            <div class="col-lg-10 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                <p style="text-align: justify">Berdiri pada tahun 2017 sebagai PT Prama Madya Parama yang sbeelumnya dikenal sebagai armada yang terpercaya bertahun-tahun sebagai armada distributor es balok. Karena kepuasan mitra bisnis terhadap layanan kami maka semakin banyak permintaan sebagai logistic dan akhirnya prama berdiri pada tahun 2017. Semakin berkembangnya prama karena loyalitas mitra yang puas dengan manajemen dan pelayanan kami. Hadirnya Prama Logistik untuk merajut kota dan merajit pulau di Indonesia.</p>
            </div>
        </div>
    </div>
</section>
<section class="visimisi">
    <div class="container">
        <h1 style="color: #FE3F00; text-align: center; margin-bottom:3%;">VISI MISI</h1>
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 col-sm-12 col-12 d-flex align-items-center mb_30" data-aos="zoom-out" data-aos-delay="100">
                <div class="content">
                    ...
                    <div class="content-details fadeIn-bottom">
                        <p class="content-text">Menjadi perusahaan transportasi yang kompetitif dengan mengutamakan kepuasan pelanggan</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 col-12 d-flex align-items-center mb_30" data-aos="zoom-out" data-aos-delay="100">
                <div class="content">
                    ...
                    <div class="content-details fadeIn-bottom">
                        <p>Mengintegrasikan jasa pengiriman barang dalam satu sistem teknologi yang inovatif dan selalu dapat diandalkan dengan menghidupi nilai nilai luhur perusahaan dalam kasih persaudaraan</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="armada">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <h1 style="color: #FE3F00; text-align: center; margin-bottom:4%;">PERCAYAKAN BARANG DAN LOGISTIK ANDA KEPADA KAMI</h1>
            </div>
        </div>
    </div>
...
<section class="kantor">
    <div class="container" data-aos="fade-up">
        <h1 style="color: #FE3F00; text-align: center; margin-bottom:4%;">KANTOR KAMI</h1>
        <div class="row justify-content-center">
